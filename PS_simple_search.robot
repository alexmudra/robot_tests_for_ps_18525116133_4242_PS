...
${index_>=1}
${index_==0}
${string_nichogo}   "Нічого незнайдено"
${znaideno}   Знайдено: 2 478
...
Check results for bruht via Chrome
    ...
    ${value1}=  get value    ${value from znaideno == 0}
    Log To Console  ${value1}


    ${2}=      find element    ${znaideno : value_all gtring path}  and get text  ${znaideno : value_all gtring path}
    Log To Console  ${2}
